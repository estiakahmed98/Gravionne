...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    function getWebGLContext(canvas: HTMLCanvasElement) {
      ...
      type FormatDescriptor = { internalFormat: number; format: number } | null;

      let formatRGBA: FormatDescriptor;
      let formatRG: FormatDescriptor;
      let formatR: FormatDescriptor;
    ...
    function generateColor(): ColorRGB {
      const c = HSVtoRGB(Math.random(), 0.8, 0.9);
      c.r *= 0.08;
      c.g *= 0.08;
      c.b *= 0.08;
      return c;
