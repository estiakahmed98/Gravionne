...
export default function RecentBlogs() {
  ...
  if (loading) {
    return (
      <div className="rounded-2xl border border-[#C2A36A]/20 bg-white/80 backdrop-blur-sm shadow-sm overflow-hidden">
        {/* Header */}
  ...
  return (
    <div className="rounded-2xl border border-[#C2A36A]/20 bg-white/80 backdrop-blur-sm shadow-sm overflow-hidden">
      ...
      <div className="p-5 border-b bg-muted/40 flex items-center gap-3">
        <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#C2A36A]/15">
          <BookOpen className="h-5 w-5 text-[#C2A36A]" />
        </div>
        <h3 className="text-lg font-semibold text-[#C2A36A]">
          Recent Articles
        </h3>
      </div>
